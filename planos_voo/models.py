...
class PlanoVoo (models.Model):
    ...
    duracaoHora = models.CharField(max_length=2, null=True)
    duracaoMinutos = models.CharField(max_length=2, null=True)
    aerodromoAlternativo = models.CharField(max_length=4, null=True)
    outrosDados = models.TextField(null=True)
    autonomiaHora = models.CharField(max_length=2, null=True)
    autonomiaMinutos = models.CharField(max_length=2, null=True)
